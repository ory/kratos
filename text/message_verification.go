...
func NewVerificationEmailSent() *Message {
	return &Message{
		...
		Type:    Info,
		Text:    "An email containing a verification link has been sent to the email address you provided. If you have not received an email, check the spelling of the address.",
		Context: context(nil),
	}
}
...
func NewVerificationEmailWithCodeSent() *Message {
	return &Message{
		...
		Type:    Info,
		Text:    "An email containing a verification code has been sent to the email address you provided. If you have not received an email, check the spelling of the address.",
		Context: context(nil),
	}
}
