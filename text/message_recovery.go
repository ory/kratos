...
func NewRecoveryEmailSent() *Message {
	return &Message{
		...
		Type:    Info,
		Text:    "An email containing a recovery link has been sent to the email address you provided. If you have not received an email, check the spelling of the address.",
		Context: context(nil),
	}
}
...
func NewRecoveryEmailWithCodeSent() *Message {
	return &Message{
		...
		Type:    Info,
		Text:    "An email containing a recovery code has been sent to the email address you provided. If you have not received an email, check the spelling of the address.",
		Context: context(nil),
	}
}
