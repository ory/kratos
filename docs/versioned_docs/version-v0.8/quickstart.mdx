...
cd kratos
git checkout v0.8.0-alpha.1.pre.0
...
[`./contrib/quickstart/kratos`](https://github.com/ory/kratos/tree/v0.8.0-alpha.1.pre.0/contrib/quickstart/kratos/email-password)
,
[`./quickstart.yml`](https://github.com/ory/kratos/blob/v0.8.0-alpha.1.pre.0/quickstart.yml),
and
[`./quickstart-standalone.yml`](https://github.com/ory/kratos/blob/v0.8.0-alpha.1.pre.0/quickstart-standalone.yml).
...
values for
[`identity.default_schema_url`](https://github.com/ory/kratos/blob/v0.8.0-alpha.1.pre.0/contrib/quickstart/kratos/email-password/kratos.yml#L75)
and
[`DSN`](https://github.com/ory/kratos/blob/v0.8.0-alpha.1.pre.0/quickstart.yml#L42).
You should also configure
[`selfservice.flows.*.ui_url`](https://github.com/ory/kratos/blob/v0.8.0-alpha.1.pre.0/contrib/quickstart/kratos/email-password/kratos.yml#L24)
