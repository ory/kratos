...
- **Helping with open issues.** We have a lot of open issues for ORY Kratos and
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for Kratos](https://github.com/ory/ory/kratos/blob/master/.github/semantic.yml)
   (if applicable).
