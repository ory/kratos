...
endpoint
([REST API Reference](rest-api#initialize-recovery-flow-for-api-clients))
...
([REST API Reference](rest-api#get-recovery-flow)) is usually
...
$ curl -H "Accept: application/json" -s \
    'http://127.0.0.1:4434/self-service/recovery/flows?id=199a2c74-08ca-4f22-b24c-3de3032682f8' | \
