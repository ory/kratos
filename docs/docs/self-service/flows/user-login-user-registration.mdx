...
This is a high-level description of the flow which is then implemented
by [several strategies](../strategies/index.md) such as *"Username or Email
and Password"* or *"Social Sign In"*.
...
To prevent brute force, guessing, session injection, and other attacks,
