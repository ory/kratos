...
<Question tags={['kratos', 'database']}>
  ...
  <p>
    ...
    login/registration endpoints if you like. You may need to tell your
...
<Question tags={['kratos', 'traits', 'KYC']}>
  #kratos #traits #KYC
  <p>
    <strong>Q</strong>: Some of our identity trait fields may be the subject to
...
<Question tags={['kratos', 'traits']}>
  #kratos #traits
  <p>
    <strong>Q</strong>: I want read-only or hidden user-specific data. Can i
    use traits for that?
  </p>
  <p>
    <strong>A</strong>: Traits are currently visible to and editable by users. Although it makes sense to have read-only and/or hidden
