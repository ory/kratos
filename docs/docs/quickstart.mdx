...
1. SecureApp used the ORY Kratos JavaScript language client to
   [guard the `/dashboard`](https://github.com/ory/kratos-selfservice-ui-node/blob/v0.4.2-alpha.1/src/index.ts#L111)
...
[`./contrib/quickstart/kratos`](https://github.com/ory/kratos/tree/v0.4.2-alpha.1/contrib/quickstart/kratos/email-password)
,
[`./quickstart.yml`](https://github.com/ory/kratos/blob/v0.4.2-alpha.1/quickstart.yml),
and
[`./quickstart-standalone.yml`](https://github.com/ory/kratos/blob/v0.4.2-alpha.1/quickstart-standalone.yml).
...
values for
[`identity.default_schema_url`](https://github.com/ory/kratos/blob/v0.4.2-alpha.1/contrib/quickstart/kratos/email-password/.kratos.yml#L67)
and
[`DSN`](https://github.com/ory/kratos/blob/v0.4.2-alpha.1/quickstart.yml#L42).
You should also configure
[`selfservice.flows.*.ui_url`](https://github.com/ory/kratos/blob/v0.4.2-alpha.1/contrib/quickstart/kratos/email-password/.kratos.yml#L40)
