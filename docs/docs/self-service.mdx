...
import {initApiFlow, initBrowserFlow} from './self-service/flows/code/login'
...
```html
<form action="http://127.0.0.1:4433/self-service/login?flow=f6209031-38d5-48bc-b6a5-118e8a24d1fe" method="POST">
