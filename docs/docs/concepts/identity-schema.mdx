...
Visit this [issue](https://github.com/ory/kratos/issues/47) for information on a
feature that would prevent the end-user from viewing/editing the identity
traits.
...
OIDC providers like Google or GitHub you write
[jsonnet code](https://jsonnet.org). Please visit to the
[Social Login Guide](https://www.ory.sh/kratos/docs/next/guides/sign-in-with-github-google-facebook-linkedin)
to learn more about Ory Kratos use of jsonnet.
