...
of the
[Password Hashing Competition (PHC)](https://github.com/P-H-C/phc-winner-argon2), or Bcrypt.
...
By default, Kratos uses Argon2 algorithm for password hashing. Use the following option
to use Bcrypt algorithm:
