...
When a user signs up using this strategy, the Default Identity JSON Schema
(set using `identity.default_schema_url`) is used:
...
[Identity Data Model Chapter](../../concepts/identity-data-model) in the docs'
concepts section.
