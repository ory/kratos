    ...
    oidc:
      providers:
        - # REQUIRED - The ID of the provider.
          ...
          # requested_claims string encoded json object that specifies claims and optionally their properties which should
          ...
          requested_claims: '{"id_token":{"email":{"essential":true},"email_verified":{"essential":true}}}'
```
