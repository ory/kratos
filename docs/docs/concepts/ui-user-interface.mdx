...
###### You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -946761.52 minutes. (1060001)
...
{
  "id": 1060001,
  "text": "You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -946761.52 minutes.",
  "type": "info",
  "context": {
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T12:22:32.44306744Z"
  }
}
```
