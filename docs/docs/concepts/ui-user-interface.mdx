...
###### You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -945555.90 minutes. (1060001)

```json
{
  "id": 1060001,
  "text": "You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -945555.90 minutes.",
  "type": "info",
  "context": {
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T16:16:54.766619511Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T16:16:54.766628357Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T16:16:54.766438822Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T16:16:54.766632155Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T16:16:52.766577037Z"
  }
}
```
