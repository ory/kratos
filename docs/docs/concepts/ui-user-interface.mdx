...
```json
{
  ...
  "context": {
    "display_name": "{name}",
    "added_at": "2021-10-18T09:04:41.990818154Z"
  }
}
```
...
###### Secret was used at 2021-10-18 09:04:41.990818154 +0000 UTC m=+2.030728174 (1050014)

```json
{
  "id": 1050014,
  "text": "Secret was used at 2021-10-18 09:04:41.990818154 +0000 UTC m=+2.030728174",
  "type": "info",
  "context": {
    "used_at": "2021-10-18T09:04:41.990818154Z"
  }
}
```
...
```json
{
  ...
  "type": "info",
  "context": {
    "privilegedSessionExpiresAt": "2021-10-18T09:05:42.990818395Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T09:04:43.991000563Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T09:04:43.991009298Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T09:04:43.990826206Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T09:04:43.991013588Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T09:04:41.990954039Z"
  }
}
```
