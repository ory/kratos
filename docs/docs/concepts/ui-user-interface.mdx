...
```json
{
  ...
  "type": "info",
  "context": {
    "added_at": "2021-10-17T10:59:11.065811+02:00",
    "display_name": "{name}"
  }
}
```
...
###### Secret was used at 2021-10-17 10:59:11.065811 +0200 CEST m=+1.096805172 (1050014)

```json
{
  "id": 1050014,
  "text": "Secret was used at 2021-10-17 10:59:11.065811 +0200 CEST m=+1.096805172",
  "type": "info",
  "context": {
    "used_at": "2021-10-17T10:59:11.065811+02:00"
  }
}
```
...
```json
{
  ...
  "type": "info",
  "context": {
    "privilegedSessionExpiresAt": "2021-10-17T11:00:12.065811+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T10:59:13.066385+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T10:59:13.066397+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T10:59:13.06583+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T10:59:13.0664+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T10:59:11.066343+02:00"
  }
}
```
