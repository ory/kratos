...
```json
{
  ...
  "context": {
    "display_name": "{name}",
    "added_at": "2021-10-18T06:21:08.738616714Z"
  }
}
```
...
###### Secret was used at 2021-10-18 06:21:08.738616714 +0000 UTC m=+1.722127627 (1050014)

```json
{
  "id": 1050014,
  "text": "Secret was used at 2021-10-18 06:21:08.738616714 +0000 UTC m=+1.722127627",
  "type": "info",
  "context": {
    "used_at": "2021-10-18T06:21:08.738616714Z"
  }
}
```
...
```json
{
  ...
  "type": "info",
  "context": {
    "privilegedSessionExpiresAt": "2021-10-18T06:22:09.738616869Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T06:21:10.738742897Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T06:21:10.738752417Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T06:21:10.738624834Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T06:21:10.738754939Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T06:21:08.738716155Z"
  }
}
```
