...
```json
{
  ...
  "context": {
    "display_name": "{name}",
    "added_at": "2021-10-18T11:55:15.149774323Z"
  }
}
```
...
###### Secret was used at 2021-10-18 11:55:15.149774323 +0000 UTC m=+1.915215684 (1050014)

```json
{
  "id": 1050014,
  "text": "Secret was used at 2021-10-18 11:55:15.149774323 +0000 UTC m=+1.915215684",
  "type": "info",
  "context": {
    "used_at": "2021-10-18T11:55:15.149774323Z"
  }
}
```
...
```json
{
  ...
  "type": "info",
  "context": {
    "privilegedSessionExpiresAt": "2021-10-18T11:56:16.149774528Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T11:55:17.149924609Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T11:55:17.149930314Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T11:55:17.1497801Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T11:55:17.149932825Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T11:55:15.149900249Z"
  }
}
```
