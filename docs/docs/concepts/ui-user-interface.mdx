...
```json
{
  ...
  "context": {
    "display_name": "{name}",
    "added_at": "2021-10-17T09:01:30.505567291Z"
  }
}
```
...
###### Secret was used at 2021-10-17 09:01:30.505567291 +0000 UTC m=+2.302322884 (1050014)

```json
{
  "id": 1050014,
  "text": "Secret was used at 2021-10-17 09:01:30.505567291 +0000 UTC m=+2.302322884",
  "type": "info",
  "context": {
    "used_at": "2021-10-17T09:01:30.505567291Z"
  }
}
```
...
```json
{
  ...
  "type": "info",
  "context": {
    "privilegedSessionExpiresAt": "2021-10-17T09:02:31.505567438Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T09:01:32.505683491Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T09:01:32.505688679Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T09:01:32.505574106Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T09:01:32.505691089Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-17T09:01:30.505659733Z"
  }
}
```
