...
<CodeFromRemote
  lang="pug"
  title="https://github.com/ory/kratos-selfservice-ui-node/blob/master/views/partials/ui_node_input_hiden.hbs"
  src="https://raw.githubusercontent.com/ory/kratos-selfservice-ui-node/master/views/partials/ui_node_input_hiden.hbs"
/>
...
###### You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -945552.60 minutes. (1060001)

```json
{
  "id": 1060001,
  "text": "You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -945552.60 minutes.",
  "type": "info",
  "context": {
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T18:13:37.090558+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T18:13:37.090569+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T18:13:37.090362+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T18:13:37.090573+02:00"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T18:13:35.090517+02:00"
  }
}
```
