...
```json
{
  ...
  "context": {
    "display_name": "{name}",
    "added_at": "2021-10-18T14:43:30.635345324Z"
  }
}
```
...
###### Secret was used at 2021-10-18 14:43:30.635345324 +0000 UTC m=+0.911926449 (1050014)

```json
{
  "id": 1050014,
  "text": "Secret was used at 2021-10-18 14:43:30.635345324 +0000 UTC m=+0.911926449",
  "type": "info",
  "context": {
    "used_at": "2021-10-18T14:43:30.635345324Z"
  }
}
```
...
```json
{
  ...
  "type": "info",
  "context": {
    "privilegedSessionExpiresAt": "2021-10-18T14:44:31.635345487Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T14:43:32.635476404Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T14:43:32.635482087Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T14:43:32.635351165Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T14:43:32.63548445Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-18T14:43:30.63544817Z"
  }
}
```
