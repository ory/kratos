...
###### You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -946560.80 minutes. (1060001)

```json
{
  "id": 1060001,
  "text": "You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -946560.80 minutes.",
  "type": "info",
  "context": {
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T09:01:48.778550653Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T09:01:48.778556139Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T09:01:48.778447517Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T09:01:48.778558517Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T09:01:46.778527441Z"
  }
}
```
