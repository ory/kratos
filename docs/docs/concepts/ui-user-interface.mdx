...
###### You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -946960.78 minutes. (1060001)

```json
{
  "id": 1060001,
  "text": "You successfully recovered your account. Please change your password or set up an alternative login method (e.g. social sign in) within the next -946960.78 minutes.",
  "type": "info",
  "context": {
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T15:41:47.685225615Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T15:41:47.685233719Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T15:41:47.68508623Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T15:41:47.685237376Z"
  }
}
```
...
```json
{
  ...
  "type": "error",
  "context": {
    "expired_at": "2021-10-19T15:41:45.685189035Z"
  }
}
```
