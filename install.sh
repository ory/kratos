#!/bin/sh
set -e
# Code generated by godownloader on 2020-07-08T12:06:59Z. DO NOT EDIT.
#
...
get_binaries() {
  case "$PLATFORM" in
    ...
    darwin/amd64) BINARIES="kratos-sqlite kratos" ;;
    ...
    linux/amd64) BINARIES="kratos-sqlite kratos-sqlite-libmusl kratos" ;;
    ...
    windows/amd64) BINARIES="kratos-sqlite kratos" ;;
