...
_Please note_: We take Ory Kratos's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Kratos, please responsibly disclose by contacting us at security@ory.sh.
...
- I have a question. Where can I get [answers to questions regarding Ory Kratos?](#communication)
...
- I want to talk to other Ory Kratos users. [How can I become a part of the community?](#communication)
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Kratos. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Kratos and some of them may lack necessary information,
...
Check out [Ory Kratos Discussions](https://github.com/ory/kratos/discussions). This is a great place for in-depth discussions and lots of code examples, logs
and similar data.
...
If you want to receive regular notifications about updates to Ory Kratos, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Kratos's roadmap and
architecture.
...
[docs](https://github.com/ory/kratos/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/kratos/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Kratos core team
  immediately.
