...
context('Login', () => {
  ...
  describe("shows validation errors when invalid signup data is used", () => {
    it('should show an error when the identifier is missing', () => {
      cy.get('button[type="submit"]').click()
      cy.get('.form-errors .message').should('contain.text', 'missing properties: identifier')
    })
    ...
    it('should show an error when the password is missing', () => {
      ...
      cy.get('button[type="submit"]').click()
      cy.get('.form-errors .message').should('contain.text', 'missing properties: password')
    })
    ...
    it('should show fail to sign in', () => {
      ...
      cy.get('button[type="submit"]').click()
      cy.get('.form-errors .message').should('contain.text', 'credentials are invalid')
    })
  })
})
