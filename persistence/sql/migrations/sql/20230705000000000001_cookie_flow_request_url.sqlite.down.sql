ALTER TABLE selfservice_login_flows ADD COLUMN request_url_new VARCHAR(1024) NOT NULL DEFAULT '';
ALTER TABLE selfservice_recovery_flows ADD COLUMN request_url_new VARCHAR(1024) NOT NULL DEFAULT '';
ALTER TABLE selfservice_registration_flows ADD COLUMN request_url_new VARCHAR(1024) NOT NULL DEFAULT '';
ALTER TABLE selfservice_settings_flows ADD COLUMN request_url_new VARCHAR(1024) NOT NULL DEFAULT '';
ALTER TABLE selfservice_verification_flows ADD COLUMN request_url_new VARCHAR(1024) NOT NULL DEFAULT '';
