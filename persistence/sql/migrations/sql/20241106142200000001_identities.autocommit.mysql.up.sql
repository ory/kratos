...
DROP INDEX IF EXISTS identity_recovery_addresses_identity_id_idx ON identity_recovery_addresses;
DROP INDEX IF EXISTS identity_verifiable_addresses_identity_id_idx ON identity_verifiable_addresses;
