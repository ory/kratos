...
DROP INDEX session_devices_id_nid_idx;
DROP INDEX session_devices_session_id_nid_idx;
...
DROP INDEX session_token_exchanges_nid_code_idx;
...
DROP INDEX courier_messages_status_idx;
...
DROP INDEX continuity_containers_identity_id_nid_idx;

CREATE INDEX identity_verification_codes_identity_verifiable_address_id_idx ON identity_verification_codes (identity_verifiable_address_id ASC);
CREATE INDEX identity_verification_codes_nid_idx ON identity_verification_codes (nid ASC);
DROP INDEX identity_verification_codes_nid_flow_id_idx;
DROP INDEX identity_verification_codes_id_nid_idx;
DROP INDEX identity_verification_codes_verifiable_address_nid_idx;
...
DROP INDEX identity_registration_codes_nid_flow_id_idx;
DROP INDEX identity_registration_codes_id_nid_idx;
...
DROP INDEX identity_recovery_tokens_token_nid_used_idx;
DROP INDEX identity_recovery_tokens_identity_id_nid_idx;

CREATE INDEX identity_recovery_codes_identity_recovery_address_id_idx ON identity_recovery_codes (identity_recovery_address_id ASC);
...
DROP INDEX identity_recovery_codes_identity_id_nid_idx;
DROP INDEX identity_recovery_codes_identity_recovery_address_id_nid_idx;

CREATE INDEX identity_login_codes_nid_idx ON identity_login_codes (nid ASC);
DROP INDEX identity_login_codes_nid_flow_id_idx;
DROP INDEX identity_login_codes_id_nid_idx;
