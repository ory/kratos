...
-- DROP INDEXIF EXISTS session_devices_id_nid_idx;
-- DROP INDEXIF EXISTS session_devices_session_id_nid_idx;
...
-- DROP INDEXIF EXISTS session_token_exchanges_nid_code_idx;
-- DROP INDEXIF EXISTS session_token_exchanges_nid_flow_id_idx;
...
-- DROP INDEXIF EXISTS courier_messages_status_idx;
-- DROP INDEXIF EXISTS courier_messages_nid_id_idx;
-- DROP INDEXIF EXISTS courier_messages_id_nid_idx;
-- DROP INDEXIF EXISTS courier_messages_nid_created_at_id_idx;
...
-- DROP INDEXIF EXISTS continuity_containers_nid_id_idx;
-- DROP INDEXIF EXISTS continuity_containers_id_nid_idx;
-- DROP INDEXIF EXISTS continuity_containers_identity_id_nid_idx;
...
-- DROP INDEXIF EXISTS identity_verification_codes_nid_flow_id_idx;
-- DROP INDEXIF EXISTS identity_verification_codes_id_nid_idx;
-- DROP INDEXIF EXISTS identity_verification_codes_verifiable_address_nid_idx;

CREATE INDEX IF NOT EXISTS identity_verification_tokens_nid_idx ON identity_verification_tokens (nid ASC);
-- DROP INDEXIF EXISTS identity_verification_tokens_nid_id_idx;
-- DROP INDEXIF EXISTS identity_verification_tokens_id_nid_idx;
-- DROP INDEXIF EXISTS identity_verification_tokens_token_nid_used_flow_id_idx;

CREATE INDEX IF NOT EXISTS identity_registration_codes_nid_idx ON identity_registration_codes (nid ASC);
-- DROP INDEXIF EXISTS identity_registration_codes_nid_flow_id_idx;
-- DROP INDEXIF EXISTS identity_registration_codes_id_nid_idx;
...
-- DROP INDEXIF EXISTS identity_recovery_tokens_nid_id_idx;
-- DROP INDEXIF EXISTS identity_recovery_tokens_id_nid_idx;
-- DROP INDEXIF EXISTS identity_recovery_tokens_token_nid_used_idx;
-- DROP INDEXIF EXISTS identity_recovery_tokens_identity_id_nid_idx;
...
-- DROP INDEXIF EXISTS identity_recovery_codes_nid_flow_id_idx;
-- DROP INDEXIF EXISTS identity_recovery_codes_id_nid_idx;
-- DROP INDEXIF EXISTS identity_recovery_codes_identity_id_nid_idx;
-- DROP INDEXIF EXISTS identity_recovery_codes_identity_recovery_address_id_nid_idx;

CREATE INDEX IF NOT EXISTS identity_login_codes_nid_idx ON identity_login_codes (nid ASC);
-- DROP INDEXIF EXISTS identity_login_codes_nid_flow_id_idx;
-- DROP INDEXIF EXISTS identity_login_codes_id_nid_idx;
