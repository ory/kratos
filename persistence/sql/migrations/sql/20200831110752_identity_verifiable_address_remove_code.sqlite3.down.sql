...
INSERT INTO "_identity_verifiable_addresses_tmp" (id, status, via, verified, value, verified_at, identity_id, created_at, updated_at, code) SELECT id, status, via, verified, value, verified_at, identity_id, created_at, updated_at, code FROM "identity_verifiable_addresses";
