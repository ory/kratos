	...
	*/
	...
	/*
		...
		You cannot delete password or code auth credentials through this API.
			 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			 * @param id ID is the identity's ID.
			 * @param type_ Type is the type of credentials to delete. oidc DeletableCredentialsTypeOIDC totp DeletableCredentialsTypeTOTP lookup_secret DeletableCredentialsTypeLookup webauthn DeletableCredentialsTypeWebAuthn
