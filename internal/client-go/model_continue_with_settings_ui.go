...
type ContinueWithSettingsUi struct {
	...
	Flow   *ContinueWithSettingsUiFlow `json:"flow,omitempty"`
}
...
func NewContinueWithSettingsUi(action string) *ContinueWithSettingsUi {
...
func (o *ContinueWithSettingsUi) HasFlow() bool {
	if o != nil && !IsNil(o.Flow) {
		return true
	}
...
// SetFlow gets a reference to the given ContinueWithSettingsUiFlow and assigns it to the Flow field.
...
func (o *ContinueWithSettingsUi) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varContinueWithSettingsUi)
