...
*IdentityApi* | [**DeleteIdentityCredential**](docs/IdentityApi.md#deleteidentitycredential) | **Delete** /admin/identities/{id}/credential/{type} | Delete a credential for a specific identity
