...
type ContinueWithRecoveryUi struct {
	...
	Flow   *ContinueWithRecoveryUiFlow `json:"flow,omitempty"`
}
...
func NewContinueWithRecoveryUi(action string) *ContinueWithRecoveryUi {
...
func (o *ContinueWithRecoveryUi) HasFlow() bool {
	if o != nil && !IsNil(o.Flow) {
		return true
	}
...
// SetFlow gets a reference to the given ContinueWithRecoveryUiFlow and assigns it to the Flow field.
...
func (o *ContinueWithRecoveryUi) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varContinueWithRecoveryUi)
