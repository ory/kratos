...
| _V0alpha2Api_ | [**AdminGetSession**](docs/V0alpha2Api.md#admingetsession)                             | **Get** /admin/sessions/{id}               | This endpoint returns the session object with expandables specified. |
