...
*V0alpha2Api* | [**AdminListIdentitySessions**](docs/V0alpha2Api.md#adminlistidentitysessions) | **Delete** /identities/{id}/sessions | This endpoint returns all sessions that belong to the given Identity.
