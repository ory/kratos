...
// SettingsFlowMethodConfig struct for SettingsFlowMethodConfig
...
func (o SettingsFlowMethodConfig) MarshalJSON() ([]byte, error) {
...
type NullableSettingsFlowMethodConfig struct {
	value *SettingsFlowMethodConfig
	isSet bool
}

func (v NullableSettingsFlowMethodConfig) Get() *SettingsFlowMethodConfig {
	return v.value
}

func (v *NullableSettingsFlowMethodConfig) Set(val *SettingsFlowMethodConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableSettingsFlowMethodConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableSettingsFlowMethodConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSettingsFlowMethodConfig(val *SettingsFlowMethodConfig) *NullableSettingsFlowMethodConfig {
	return &NullableSettingsFlowMethodConfig{value: val, isSet: true}
}

func (v NullableSettingsFlowMethodConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSettingsFlowMethodConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
