...
func (o *InitializeSelfServiceBrowserLogoutFlowParams) WithDefaults() *InitializeSelfServiceBrowserLogoutFlowParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *InitializeSelfServiceBrowserLogoutFlowParams) SetDefaults() {
