...
// RecoveryFlowMethodConfig RecoveryFlowMethodConfig RecoveryFlowMethodConfig RecoveryFlowMethodConfig recovery flow method config
//
...
func (m *RecoveryFlowMethodConfig) validateAction(formats strfmt.Registry) error {
...
func (m *RecoveryFlowMethodConfig) validateFields(formats strfmt.Registry) error {
...
func (m *RecoveryFlowMethodConfig) UnmarshalBinary(b []byte) error {
	var res RecoveryFlowMethodConfig
