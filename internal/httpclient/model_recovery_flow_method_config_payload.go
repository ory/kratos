...
func (o RecoveryFlowMethodConfigPayload) MarshalJSON() ([]byte, error) {
...
type NullableRecoveryFlowMethodConfigPayload struct {
	value *RecoveryFlowMethodConfigPayload
	isSet bool
}

func (v NullableRecoveryFlowMethodConfigPayload) Get() *RecoveryFlowMethodConfigPayload {
	return v.value
}

func (v *NullableRecoveryFlowMethodConfigPayload) Set(val *RecoveryFlowMethodConfigPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryFlowMethodConfigPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryFlowMethodConfigPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryFlowMethodConfigPayload(val *RecoveryFlowMethodConfigPayload) *NullableRecoveryFlowMethodConfigPayload {
	return &NullableRecoveryFlowMethodConfigPayload{value: val, isSet: true}
}

func (v NullableRecoveryFlowMethodConfigPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryFlowMethodConfigPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
