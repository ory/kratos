...
// OidcStrategyRequestMethod oidc strategy request method
...
func (m *OidcStrategyRequestMethod) validateErrors(formats strfmt.Registry) error {
...
func (m *OidcStrategyRequestMethod) validateFields(formats strfmt.Registry) error {
...
func (m *OidcStrategyRequestMethod) validateProviders(formats strfmt.Registry) error {
...
func (m *OidcStrategyRequestMethod) UnmarshalBinary(b []byte) error {
	var res OidcStrategyRequestMethod
