...
type Persister interface {
	...
	ListSessions(ctx context.Context, active *bool, paginator *keysetpagination.Paginator, expandables Expandables) ([]Session, int64, *keysetpagination.Paginator, error)
