...
func (t *RecoveryValid) EmailSubject() (string, error) {
	return LoadTextTemplate(t.c.CourierTemplatesRoot(), "recovery/valid/email.subject.gotmpl", "recovery/valid/email.subject*", t.m, nil)
}

func (t *RecoveryValid) EmailBody() (string, error) {
	return LoadHTMLTemplate(t.c.CourierTemplatesRoot(), "recovery/valid/email.body.gotmpl", "recovery/valid/email.body*", t.m, nil)
}

func (t *RecoveryValid) EmailBodyPlaintext() (string, error) {
	return LoadTextTemplate(t.c.CourierTemplatesRoot(), "recovery/valid/email.body.plaintext.gotmpl", "recovery/valid/email.body.plaintext*", t.m, nil)
}
