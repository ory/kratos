...
func (t *RecoveryValid) EmailSubject(ctx context.Context) (string, error) {
	return LoadTextTemplate(ctx, t.d, os.DirFS(t.d.CourierConfig(ctx).CourierTemplatesRoot()),
		"recovery/valid/email.subject.gotmpl",
		"recovery/valid/email.subject*",
		t.m,
		t.d.CourierConfig(ctx).CourierTemplatesRecoveryValid().Subject,
		t.d.CourierConfig(ctx).CourierTemplatesRecoveryValid().TemplateRoot,
	)
}
...
func (t *RecoveryValid) EmailBody(ctx context.Context) (string, error) {
	return LoadHTMLTemplate(ctx, t.d,
		...
		"recovery/valid/email.body*",
		t.m,
		t.d.CourierConfig(ctx).CourierTemplatesRecoveryValid().Body.HTML,
		t.d.CourierConfig(ctx).CourierTemplatesRecoveryValid().TemplateRoot,
	)
}
...
func (t *RecoveryValid) EmailBodyPlaintext(ctx context.Context) (string, error) {
	return LoadTextTemplate(ctx, t.d,
		os.DirFS(t.d.CourierConfig(ctx).CourierTemplatesRoot()),
		"recovery/valid/email.body.plaintext.gotmpl",
		"recovery/valid/email.body.plaintext*",
		t.m,
		t.d.CourierConfig(ctx).CourierTemplatesRecoveryValid().Body.PlainText,
		t.d.CourierConfig(ctx).CourierTemplatesRecoveryValid().TemplateRoot,
	)
}
