...
func TestNewFlow(t *testing.T) {
	...
	t.Run("should parse login_challenge when Hydra is configured", func(t *testing.T) {
		...
		conf.MustSet(ctx, config.ViperKeySelfServiceOAuth2ProviderURL, "https://hydra")
		...
		require.NoError(t, err)
		assert.Equal(t, "8aadcb8f-c133-4186-a84c-4da9813356d9", r.HydraLoginChallenge.UUID.String())
	})
