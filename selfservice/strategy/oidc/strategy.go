...
type Strategy struct {
	...
	conflictingIdentityPolicy func(existingIdentity, newIdentity *identity.Identity, provider Provider, emailVerified bool) ConflictingIdentityVerdict
}
...
func WithOnConflictingIdentity(handler func(existingIdentity, newIdentity *identity.Identity, provider Provider, emailProvider bool) ConflictingIdentityVerdict) NewStrategyOpt {
...
// called in tests.
func (s *Strategy) SetOnConflictingIdentity(t testing.TB, handler func(existingIdentity, newIdentity *identity.Identity, provider Provider, emailVerified bool) ConflictingIdentityVerdict) {
	if t == nil {
