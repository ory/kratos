...
func TestVerification(t *testing.T) {
	...
	var expect = func(t *testing.T, hc *http.Client, isAPI, isSPA bool, values func(url.Values), c int) string {
		...
		u := testhelpers.ExpectURL(isAPI || isSPA, public.URL+verification.RouteSubmitFlow, conf.SelfServiceFlowVerificationUI(ctx).String())

		return testhelpers.SubmitVerificationForm(t, isAPI, isSPA, hc, public, values, c, u)
	}
